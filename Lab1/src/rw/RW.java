...
// ≈сли просто поставить synchronized у методов read() write() в классе Data
// “о скорость значительно уменьшитс€

// — использованием Lock скорость снижаетс€ незначительно
