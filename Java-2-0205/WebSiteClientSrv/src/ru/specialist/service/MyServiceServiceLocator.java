...
public class MyServiceServiceLocator extends org.apache.axis.client.Service implements ru.specialist.service.MyServiceService {
    ...
    private java.lang.String MyService_address = "http://localhost/WebSite/services/MyService";
    ...
    public ru.specialist.service.MyService getMyService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ru.specialist.service.MyServiceSoapBindingStub _stub = new ru.specialist.service.MyServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ru.specialist.service.MyService.class.isAssignableFrom(serviceEndpointInterface)) {
                ru.specialist.service.MyServiceSoapBindingStub _stub = new ru.specialist.service.MyServiceSoapBindingStub(new java.net.URL(MyService_address), this);
                _stub.setPortName(getMyServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.specialist.ru", "MyServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.specialist.ru", "MyService"));
        }
